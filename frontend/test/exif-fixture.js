// Shared test fixture: hand-assembled JPEG bytes with an EXIF GPS block.
// Used by exif.test.js (parser unit tests) and upload.test.js (e2e auto-geotag).
...
export function buildJpegWithGps({ latRef = 'N', lngRef = 'E', lat = [42, 41, 51.72], lng = [23, 19, 18.84], dateTimeOriginal = '2024:06:01 12:34:56' } = {}) {
