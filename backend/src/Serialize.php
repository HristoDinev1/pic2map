...
final class Serialize
{
    public static function photo(array $p): array
    {
        return [
            ...
            'urls' => [
                'original' => S3::resolveUrl($p['s3_key_original'] ?? null),
                'thumb' => S3::resolveUrl($p['s3_key_thumb'] ?? null),
                'medium' => S3::resolveUrl($p['s3_key_medium'] ?? null),
                'large' => S3::resolveUrl($p['s3_key_large'] ?? null),
            ],
